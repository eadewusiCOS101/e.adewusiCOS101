...
electrical/electronic engineering proffessionals in the areas 
...
innovative, enterprenurial and ethically minded persons 
capable of creating value in diverse feilds of computer science.", w3);
}
